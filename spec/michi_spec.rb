...
describe "Michi" do
	it ("Inicio de juego tablero sin marcar") do
		juego=Michi.new
		expect( juego.pos_0 ).to eq "0"
		expect( juego.pos_1 ).to eq "0"
		expect( juego.pos_2 ).to eq "0"
	end
